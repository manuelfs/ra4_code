// Adapted for cfA from https://github.com/cms-sw/cmssw/blob/CMSSW_7_2_X/CondFormats/JetMETObjects/interface/Utilities.h

#ifndef JEC_Utilities_hpp
#define JEC_Utilities_hpp
...
namespace
{
  __attribute__((noreturn)) void handleError(const std::string& fClass, const std::string& fMessage)
  {
