...
public:
  ...
  bool IsBasicMuon(unsigned iel) const;
  ...
  bool IsBasicElectron(unsigned iel) const;
  ...
  std::vector<int> GetJets(std::vector<int> SigEl, std::vector<int> SigMu, 
                           std::vector<int> VetoEl, std::vector<int> VetoMu, float &HT) const;
  ...
  // Truth matching
  int GetTrueElectron(int index, int &momID, double &closest_dR) const;
  int GetTrueMuon(int index, int &momID, double &closest_dR) const;
