...
public:
  ...
  std::vector<float>* const & els_PATpassConversionVeto(const bool mux = true) const;
  std::vector<float>* const & els_PFchargedHadronIsoR03(const bool mux = true) const;
  std::vector<float>* const & els_PFneutralHadronIsoR03(const bool mux = true) const;
  std::vector<float>* const & els_PFphotonIsoR03(const bool mux = true) const;
  std::vector<float>* const & els_basicClustersSize(const bool mux = true) const;
  std::vector<float>* const & els_cIso(const bool mux = true) const;
  std::vector<float>* const & els_caloEnergy(const bool mux = true) const;
  std::vector<float>* const & els_charge(const bool mux = true) const;
  std::vector<float>* const & els_chi2(const bool mux = true) const;
  std::vector<float>* const & els_conversion_dcot(const bool mux = true) const;
  std::vector<float>* const & els_conversion_dist(const bool mux = true) const;
  std::vector<float>* const & els_core_ecalDrivenSeed(const bool mux = true) const;
  std::vector<float>* const & els_cpx(const bool mux = true) const;
  std::vector<float>* const & els_cpy(const bool mux = true) const;
  std::vector<float>* const & els_cpz(const bool mux = true) const;
  std::vector<float>* const & els_ctf_tk_charge(const bool mux = true) const;
  std::vector<float>* const & els_ctf_tk_eta(const bool mux = true) const;
  std::vector<float>* const & els_ctf_tk_id(const bool mux = true) const;
  std::vector<float>* const & els_ctf_tk_phi(const bool mux = true) const;
  std::vector<float>* const & els_cx(const bool mux = true) const;
  std::vector<float>* const & els_cy(const bool mux = true) const;
  std::vector<float>* const & els_cz(const bool mux = true) const;
  std::vector<float>* const & els_d0dum(const bool mux = true) const;
  std::vector<float>* const & els_d0dumError(const bool mux = true) const;
  std::vector<float>* const & els_dEtaIn(const bool mux = true) const;
  std::vector<float>* const & els_dEtaOut(const bool mux = true) const;
  std::vector<float>* const & els_dPhiIn(const bool mux = true) const;
  std::vector<float>* const & els_dPhiOut(const bool mux = true) const;
  std::vector<float>* const & els_dr03EcalRecHitSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr03HcalDepth1TowerSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr03HcalDepth2TowerSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr03HcalTowerSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr03TkSumPt(const bool mux = true) const;
  std::vector<float>* const & els_dr04EcalRecHitSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr04HcalDepth1TowerSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr04HcalDepth2TowerSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr04HcalTowerSumEt(const bool mux = true) const;
  std::vector<float>* const & els_dr04TkSumPt(const bool mux = true) const;
  std::vector<float>* const & els_dz(const bool mux = true) const;
  std::vector<float>* const & els_dzError(const bool mux = true) const;
  std::vector<float>* const & els_eOverPIn(const bool mux = true) const;
  std::vector<float>* const & els_eSeedOverPOut(const bool mux = true) const;
  std::vector<float>* const & els_ecalIso(const bool mux = true) const;
  std::vector<float>* const & els_energy(const bool mux = true) const;
  std::vector<float>* const & els_et(const bool mux = true) const;
  std::vector<float>* const & els_eta(const bool mux = true) const;
  std::vector<float>* const & els_etaError(const bool mux = true) const;
  std::vector<float>* const & els_fbrem(const bool mux = true) const;
  std::vector<float>* const & els_full5x5_sigmaIetaIeta(const bool mux = true) const;
  std::vector<float>* const & els_gen_et(const bool mux = true) const;
  std::vector<float>* const & els_gen_eta(const bool mux = true) const;
  std::vector<float>* const & els_gen_id(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_et(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_eta(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_id(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_phi(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_pt(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_px(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_py(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_pz(const bool mux = true) const;
  std::vector<float>* const & els_gen_mother_theta(const bool mux = true) const;
  std::vector<float>* const & els_gen_phi(const bool mux = true) const;
  std::vector<float>* const & els_gen_pt(const bool mux = true) const;
  std::vector<float>* const & els_gen_px(const bool mux = true) const;
  std::vector<float>* const & els_gen_py(const bool mux = true) const;
  std::vector<float>* const & els_gen_pz(const bool mux = true) const;
  std::vector<float>* const & els_gen_theta(const bool mux = true) const;
  std::vector<float>* const & els_hadOverEm(const bool mux = true) const;
  std::vector<bool>* const & els_hasMatchedConversion(const bool mux = true) const;
  std::vector<float>* const & els_hcalIso(const bool mux = true) const;
  std::vector<float>* const & els_hcalOverEcalBc(const bool mux = true) const;
  std::vector<float>* const & els_isEB(const bool mux = true) const;
  std::vector<float>* const & els_isEE(const bool mux = true) const;
  std::vector<bool>* const & els_isPF(const bool mux = true) const;
  std::vector<int>* const & els_jet_ind(const bool mux = true) const;
  std::vector<float>* const & els_looseId(const bool mux = true) const;
  std::vector<float>* const & els_n_inner_layer(const bool mux = true) const;
  std::vector<float>* const & els_n_outer_layer(const bool mux = true) const;
  std::vector<float>* const & els_ndof(const bool mux = true) const;
  std::vector<float>* const & els_numlosthits(const bool mux = true) const;
  std::vector<float>* const & els_numvalhits(const bool mux = true) const;
  std::vector<float>* const & els_pfIsolationR03_sumChargedHadronPt(const bool mux = true) const;
  std::vector<float>* const & els_pfIsolationR03_sumNeutralHadronEt(const bool mux = true) const;
  std::vector<float>* const & els_pfIsolationR03_sumPUPt(const bool mux = true) const;
  std::vector<float>* const & els_pfIsolationR03_sumPhotonEt(const bool mux = true) const;
  std::vector<float>* const & els_phi(const bool mux = true) const;
  std::vector<float>* const & els_phiError(const bool mux = true) const;
  std::vector<float>* const & els_pt(const bool mux = true) const;
  std::vector<float>* const & els_ptError(const bool mux = true) const;
  std::vector<float>* const & els_px(const bool mux = true) const;
  std::vector<float>* const & els_py(const bool mux = true) const;
  std::vector<float>* const & els_pz(const bool mux = true) const;
  std::vector<float>* const & els_robustHighEnergyId(const bool mux = true) const;
  std::vector<float>* const & els_robustLooseId(const bool mux = true) const;
  std::vector<float>* const & els_robustTightId(const bool mux = true) const;
  std::vector<float>* const & els_scE1x5(const bool mux = true) const;
  std::vector<float>* const & els_scE2x5Max(const bool mux = true) const;
  std::vector<float>* const & els_scE5x5(const bool mux = true) const;
  std::vector<float>* const & els_scEnergy(const bool mux = true) const;
  std::vector<float>* const & els_scEta(const bool mux = true) const;
  std::vector<float>* const & els_scEtaWidth(const bool mux = true) const;
  std::vector<float>* const & els_scPhi(const bool mux = true) const;
  std::vector<float>* const & els_scPhiWidth(const bool mux = true) const;
  std::vector<float>* const & els_scRawEnergy(const bool mux = true) const;
  std::vector<float>* const & els_scSeedEnergy(const bool mux = true) const;
  std::vector<float>* const & els_shFracInnerHits(const bool mux = true) const;
  std::vector<float>* const & els_sigmaEtaEta(const bool mux = true) const;
  std::vector<float>* const & els_sigmaIEtaIEta(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId60cIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId60relIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId70cIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId70relIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId80cIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId80relIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId85cIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId85relIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId90cIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId90relIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId95cIso(const bool mux = true) const;
  std::vector<float>* const & els_simpleEleId95relIso(const bool mux = true) const;
  std::vector<float>* const & els_status(const bool mux = true) const;
  std::vector<float>* const & els_tIso(const bool mux = true) const;
  std::vector<float>* const & els_theta(const bool mux = true) const;
  std::vector<float>* const & els_tightId(const bool mux = true) const;
  std::vector<float>* const & els_tk_charge(const bool mux = true) const;
  std::vector<float>* const & els_tk_eta(const bool mux = true) const;
  std::vector<float>* const & els_tk_phi(const bool mux = true) const;
  std::vector<float>* const & els_tk_pt(const bool mux = true) const;
  std::vector<float>* const & els_tk_pz(const bool mux = true) const;
  std::vector<float>* const & els_vpx(const bool mux = true) const;
  std::vector<float>* const & els_vpy(const bool mux = true) const;
  std::vector<float>* const & els_vpz(const bool mux = true) const;
  std::vector<float>* const & els_vx(const bool mux = true) const;
  std::vector<float>* const & els_vy(const bool mux = true) const;
  std::vector<float>* const & els_vz(const bool mux = true) const;
  ...
  std::vector<float>* const & mus_cIso(const bool mux = true) const;
  std::vector<float>* const & mus_calEnergyEm(const bool mux = true) const;
  std::vector<float>* const & mus_calEnergyEmS9(const bool mux = true) const;
  std::vector<float>* const & mus_calEnergyHad(const bool mux = true) const;
  std::vector<float>* const & mus_calEnergyHadS9(const bool mux = true) const;
  std::vector<float>* const & mus_calEnergyHo(const bool mux = true) const;
  std::vector<float>* const & mus_calEnergyHoS9(const bool mux = true) const;
  std::vector<float>* const & mus_charge(const bool mux = true) const;
  std::vector<float>* const & mus_cm_ExpectedHitsInner(const bool mux = true) const;
  std::vector<float>* const & mus_cm_ExpectedHitsOuter(const bool mux = true) const;
  std::vector<float>* const & mus_cm_LayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_cm_LayersWithoutMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_cm_PixelLayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_cm_ValidStripLayersWithMonoAndStereoHit(const bool mux = true) const;
  std::vector<float>* const & mus_cm_chg(const bool mux = true) const;
  std::vector<float>* const & mus_cm_chi2(const bool mux = true) const;
  std::vector<float>* const & mus_cm_d0dum(const bool mux = true) const;
  std::vector<float>* const & mus_cm_d0dumErr(const bool mux = true) const;
  std::vector<float>* const & mus_cm_dz(const bool mux = true) const;
  std::vector<float>* const & mus_cm_dzErr(const bool mux = true) const;
  std::vector<float>* const & mus_cm_eta(const bool mux = true) const;
  std::vector<float>* const & mus_cm_etaErr(const bool mux = true) const;
  std::vector<float>* const & mus_cm_ndof(const bool mux = true) const;
  std::vector<float>* const & mus_cm_numlosthits(const bool mux = true) const;
  std::vector<float>* const & mus_cm_numvalMuonhits(const bool mux = true) const;
  std::vector<float>* const & mus_cm_numvalhits(const bool mux = true) const;
  std::vector<float>* const & mus_cm_phi(const bool mux = true) const;
  std::vector<float>* const & mus_cm_phiErr(const bool mux = true) const;
  std::vector<float>* const & mus_cm_pt(const bool mux = true) const;
  std::vector<float>* const & mus_cm_ptErr(const bool mux = true) const;
  std::vector<float>* const & mus_cm_px(const bool mux = true) const;
  std::vector<float>* const & mus_cm_py(const bool mux = true) const;
  std::vector<float>* const & mus_cm_pz(const bool mux = true) const;
  std::vector<float>* const & mus_cm_theta(const bool mux = true) const;
  std::vector<float>* const & mus_cm_vx(const bool mux = true) const;
  std::vector<float>* const & mus_cm_vy(const bool mux = true) const;
  std::vector<float>* const & mus_cm_vz(const bool mux = true) const;
  std::vector<float>* const & mus_dB(const bool mux = true) const;
  std::vector<float>* const & mus_ecalIso(const bool mux = true) const;
  std::vector<float>* const & mus_ecalvetoDep(const bool mux = true) const;
  std::vector<float>* const & mus_energy(const bool mux = true) const;
  std::vector<float>* const & mus_et(const bool mux = true) const;
  std::vector<float>* const & mus_eta(const bool mux = true) const;
  std::vector<float>* const & mus_gen_et(const bool mux = true) const;
  std::vector<float>* const & mus_gen_eta(const bool mux = true) const;
  std::vector<float>* const & mus_gen_id(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_et(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_eta(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_id(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_phi(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_pt(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_px(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_py(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_pz(const bool mux = true) const;
  std::vector<float>* const & mus_gen_mother_theta(const bool mux = true) const;
  std::vector<float>* const & mus_gen_phi(const bool mux = true) const;
  std::vector<float>* const & mus_gen_pt(const bool mux = true) const;
  std::vector<float>* const & mus_gen_px(const bool mux = true) const;
  std::vector<float>* const & mus_gen_py(const bool mux = true) const;
  std::vector<float>* const & mus_gen_pz(const bool mux = true) const;
  std::vector<float>* const & mus_gen_theta(const bool mux = true) const;
  std::vector<float>* const & mus_hcalIso(const bool mux = true) const;
  std::vector<float>* const & mus_hcalvetoDep(const bool mux = true) const;
  std::vector<float>* const & mus_id_All(const bool mux = true) const;
  std::vector<float>* const & mus_id_AllArbitrated(const bool mux = true) const;
  std::vector<float>* const & mus_id_AllGlobalMuons(const bool mux = true) const;
  std::vector<float>* const & mus_id_AllStandAloneMuons(const bool mux = true) const;
  std::vector<float>* const & mus_id_AllTrackerMuons(const bool mux = true) const;
  std::vector<float>* const & mus_id_GlobalMuonPromptTight(const bool mux = true) const;
  std::vector<float>* const & mus_id_TM2DCompatibilityLoose(const bool mux = true) const;
  std::vector<float>* const & mus_id_TM2DCompatibilityTight(const bool mux = true) const;
  std::vector<float>* const & mus_id_TMLastStationLoose(const bool mux = true) const;
  std::vector<float>* const & mus_id_TMLastStationOptimizedLowPtLoose(const bool mux = true) const;
  std::vector<float>* const & mus_id_TMLastStationOptimizedLowPtTight(const bool mux = true) const;
  std::vector<float>* const & mus_id_TMLastStationTight(const bool mux = true) const;
  std::vector<float>* const & mus_id_TMOneStationLoose(const bool mux = true) const;
  std::vector<float>* const & mus_id_TMOneStationTight(const bool mux = true) const;
  std::vector<float>* const & mus_id_TrackerMuonArbitrated(const bool mux = true) const;
  std::vector<float>* const & mus_isCaloMuon(const bool mux = true) const;
  std::vector<float>* const & mus_isConvertedPhoton(const bool mux = true) const;
  std::vector<float>* const & mus_isElectron(const bool mux = true) const;
  std::vector<float>* const & mus_isGlobalMuon(const bool mux = true) const;
  std::vector<bool>* const & mus_isPF(const bool mux = true) const;
  std::vector<float>* const & mus_isPFMuon(const bool mux = true) const;
  std::vector<float>* const & mus_isPhoton(const bool mux = true) const;
  std::vector<float>* const & mus_isStandAloneMuon(const bool mux = true) const;
  std::vector<float>* const & mus_isTrackerMuon(const bool mux = true) const;
  std::vector<float>* const & mus_iso03_emEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso03_emVetoEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso03_hadEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso03_hadVetoEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso03_hoEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso03_nTracks(const bool mux = true) const;
  std::vector<float>* const & mus_iso03_sumPt(const bool mux = true) const;
  std::vector<float>* const & mus_iso05_emEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso05_hadEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso05_hoEt(const bool mux = true) const;
  std::vector<float>* const & mus_iso05_nTracks(const bool mux = true) const;
  std::vector<float>* const & mus_iso05_sumPt(const bool mux = true) const;
  std::vector<int>* const & mus_jet_ind(const bool mux = true) const;
  std::vector<float>* const & mus_num_matches(const bool mux = true) const;
  std::vector<float>* const & mus_numberOfMatchedStations(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR03_sumChargedHadronPt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR03_sumChargedParticlePt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR03_sumNeutralHadronEt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR03_sumNeutralHadronEtHighThreshold(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR03_sumPUPt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR03_sumPhotonEt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR03_sumPhotonEtHighThreshold(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR04_sumChargedHadronPt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR04_sumChargedParticlePt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR04_sumNeutralHadronEt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR04_sumNeutralHadronEtHighThreshold(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR04_sumPUPt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR04_sumPhotonEt(const bool mux = true) const;
  std::vector<float>* const & mus_pfIsolationR04_sumPhotonEtHighThreshold(const bool mux = true) const;
  std::vector<float>* const & mus_phi(const bool mux = true) const;
  std::vector<float>* const & mus_picky_ExpectedHitsInner(const bool mux = true) const;
  std::vector<float>* const & mus_picky_ExpectedHitsOuter(const bool mux = true) const;
  std::vector<float>* const & mus_picky_LayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_picky_LayersWithoutMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_picky_PixelLayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_picky_ValidStripLayersWithMonoAndStereoHit(const bool mux = true) const;
  std::vector<float>* const & mus_picky_chg(const bool mux = true) const;
  std::vector<float>* const & mus_picky_chi2(const bool mux = true) const;
  std::vector<float>* const & mus_picky_d0dum(const bool mux = true) const;
  std::vector<float>* const & mus_picky_d0dumErr(const bool mux = true) const;
  std::vector<float>* const & mus_picky_dz(const bool mux = true) const;
  std::vector<float>* const & mus_picky_dzErr(const bool mux = true) const;
  std::vector<float>* const & mus_picky_eta(const bool mux = true) const;
  std::vector<float>* const & mus_picky_etaErr(const bool mux = true) const;
  std::vector<float>* const & mus_picky_id(const bool mux = true) const;
  std::vector<float>* const & mus_picky_ndof(const bool mux = true) const;
  std::vector<float>* const & mus_picky_numlosthits(const bool mux = true) const;
  std::vector<float>* const & mus_picky_numvalPixelhits(const bool mux = true) const;
  std::vector<float>* const & mus_picky_numvalhits(const bool mux = true) const;
  std::vector<float>* const & mus_picky_phi(const bool mux = true) const;
  std::vector<float>* const & mus_picky_phiErr(const bool mux = true) const;
  std::vector<float>* const & mus_picky_pt(const bool mux = true) const;
  std::vector<float>* const & mus_picky_ptErr(const bool mux = true) const;
  std::vector<float>* const & mus_picky_px(const bool mux = true) const;
  std::vector<float>* const & mus_picky_py(const bool mux = true) const;
  std::vector<float>* const & mus_picky_pz(const bool mux = true) const;
  std::vector<float>* const & mus_picky_theta(const bool mux = true) const;
  std::vector<float>* const & mus_picky_vx(const bool mux = true) const;
  std::vector<float>* const & mus_picky_vy(const bool mux = true) const;
  std::vector<float>* const & mus_picky_vz(const bool mux = true) const;
  std::vector<float>* const & mus_pt(const bool mux = true) const;
  std::vector<float>* const & mus_px(const bool mux = true) const;
  std::vector<float>* const & mus_py(const bool mux = true) const;
  std::vector<float>* const & mus_pz(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_chg(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_chi2(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_d0dum(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_d0dumErr(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_dz(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_dzErr(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_eta(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_etaErr(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_ndof(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_numlosthits(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_numvalhits(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_phi(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_phiErr(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_pt(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_ptErr(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_px(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_py(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_pz(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_theta(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_vx(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_vy(const bool mux = true) const;
  std::vector<float>* const & mus_stamu_vz(const bool mux = true) const;
  std::vector<float>* const & mus_status(const bool mux = true) const;
  std::vector<float>* const & mus_tIso(const bool mux = true) const;
  std::vector<float>* const & mus_theta(const bool mux = true) const;
  std::vector<float>* const & mus_tkHits(const bool mux = true) const;
  std::vector<float>* const & mus_tk_ExpectedHitsInner(const bool mux = true) const;
  std::vector<float>* const & mus_tk_ExpectedHitsOuter(const bool mux = true) const;
  std::vector<float>* const & mus_tk_LayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_tk_LayersWithoutMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_tk_PixelLayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_tk_ValidStripLayersWithMonoAndStereoHit(const bool mux = true) const;
  std::vector<float>* const & mus_tk_chg(const bool mux = true) const;
  std::vector<float>* const & mus_tk_chi2(const bool mux = true) const;
  std::vector<float>* const & mus_tk_d0dum(const bool mux = true) const;
  std::vector<float>* const & mus_tk_d0dumErr(const bool mux = true) const;
  std::vector<float>* const & mus_tk_dz(const bool mux = true) const;
  std::vector<float>* const & mus_tk_dzErr(const bool mux = true) const;
  std::vector<float>* const & mus_tk_eta(const bool mux = true) const;
  std::vector<float>* const & mus_tk_etaErr(const bool mux = true) const;
  std::vector<float>* const & mus_tk_id(const bool mux = true) const;
  std::vector<float>* const & mus_tk_ndof(const bool mux = true) const;
  std::vector<float>* const & mus_tk_numlosthits(const bool mux = true) const;
  std::vector<float>* const & mus_tk_numpixelWthMeasr(const bool mux = true) const;
  std::vector<float>* const & mus_tk_numvalPixelhits(const bool mux = true) const;
  std::vector<float>* const & mus_tk_numvalhits(const bool mux = true) const;
  std::vector<float>* const & mus_tk_phi(const bool mux = true) const;
  std::vector<float>* const & mus_tk_phiErr(const bool mux = true) const;
  std::vector<float>* const & mus_tk_pt(const bool mux = true) const;
  std::vector<float>* const & mus_tk_ptErr(const bool mux = true) const;
  std::vector<float>* const & mus_tk_px(const bool mux = true) const;
  std::vector<float>* const & mus_tk_py(const bool mux = true) const;
  std::vector<float>* const & mus_tk_pz(const bool mux = true) const;
  std::vector<float>* const & mus_tk_theta(const bool mux = true) const;
  std::vector<float>* const & mus_tk_vx(const bool mux = true) const;
  std::vector<float>* const & mus_tk_vy(const bool mux = true) const;
  std::vector<float>* const & mus_tk_vz(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_ExpectedHitsInner(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_ExpectedHitsOuter(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_LayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_LayersWithoutMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_PixelLayersWithMeasurement(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_ValidStripLayersWithMonoAndStereoHit(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_chg(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_chi2(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_d0dum(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_d0dumErr(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_dz(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_dzErr(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_eta(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_etaErr(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_id(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_ndof(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_numlosthits(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_numvalPixelhits(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_numvalhits(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_phi(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_phiErr(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_pt(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_ptErr(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_px(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_py(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_pz(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_theta(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_vx(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_vy(const bool mux = true) const;
  std::vector<float>* const & mus_tpfms_vz(const bool mux = true) const;
  ...
  std::vector<float>* const & els_chargedHadronIso() const;
  std::vector<float>* const & els_neutralHadronIso() const;
  std::vector<float>* const & els_photonIso() const;
  ...
  std::vector<float>* const & mus_chargedHadronIso() const;
  std::vector<float>* const & mus_neutralHadronIso() const;
  std::vector<float>* const & mus_photonIso() const;
