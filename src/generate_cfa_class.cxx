  ...
  if(argc>1){
    ...
    if(inFile.IsOpen() && !inFile.IsZombie()){
      ...
      if(chainA!=NULL && chainB!=NULL){
        ...
        hppFile << "class cfa{\n";
        hppFile << "public:\n";
        hppFile << "  cfa(const std::string& filename);\n";
        ...
        cppFile << "cfa::cfa(const std::string& fileIn):\n";
